...
function shuffleCardImageClasses() {
  ...
  let result = _.shuffle(cardClasses);
  return result;
}
...
function onCardFlipped(newlyFlippedCard) {
  ...
  incrementCounter("flip-count", document.getElementById("flip-count"));
...
function resetGame() {
  ...
  let reset = document.getElementById("card-container");
  ...
  let resetFlip = document.getElementById("flip-count");
  resetFlip.innerHTML = 0;
  let resetMatch = document.getElementById("match-count");
